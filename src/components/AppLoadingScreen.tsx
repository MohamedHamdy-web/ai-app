...
function LoadingCard({
  ...
  return (
    <div
      className={`rounded-[1.35rem] border border-white/10 bg-white/[0.04] p-4 shadow-lg shadow-black/10 ${className}`}
    >
...
export default function AppLoadingScreen() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.16),_transparent_26%),radial-gradient(circle_at_82%_12%,_rgba(34,211,238,0.14),_transparent_24%),linear-gradient(135deg,_#06131c_0%,_#0d1724_48%,_#142235_100%)] text-white">
      <div className="mx-auto flex min-h-screen max-w-[1600px] flex-col gap-6 px-4 py-4 lg:flex-row lg:px-6 lg:py-6">
        <aside className="hidden lg:block lg:w-[22rem] lg:shrink-0">
          <div className="flex h-[calc(100vh-3rem)] flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/25 backdrop-blur-xl">
        ...
        <main className="min-w-0 flex-1">
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.035] p-4 shadow-2xl shadow-black/20 backdrop-blur-xl sm:p-6 lg:min-h-[calc(100vh-3rem)] lg:p-8"
          >
            <motion.div
              aria-hidden="true"
              animate={{
              ...
              className="pointer-events-none absolute inset-x-0 top-0 h-64 bg-[radial-gradient(circle_at_top,_rgba(52,211,153,0.16),_transparent_60%)]"
            />

            <div className="relative">
              <div className="rounded-[1.75rem] border border-white/10 bg-white/[0.045] px-5 py-4 shadow-lg shadow-black/10">
              ...
              <section className="mt-6 flex flex-col gap-4">
                <div className="rounded-[1.75rem] border border-white/10 bg-white/[0.045] p-5 shadow-xl shadow-black/15">
                  ...
                  <div className="mt-5 grid gap-5 xl:grid-cols-[1.15fr,0.85fr]">
                    ...
                    <div className="flex flex-col justify-between rounded-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(8,16,24,0.94),rgba(10,22,34,0.88))] p-5">
                      <div>
                        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-white/60">
                          Session setup
                        </div>
                      ...
                      <div className="mt-6 space-y-3">
                        {[
                          ...
                          <motion.div
                            ...
                            className="flex items-center gap-3 rounded-[1.2rem] border border-white/10 bg-white/[0.04] px-4 py-3"
                          >
                ...
                <div className="rounded-[1.6rem] border border-white/10 bg-[linear-gradient(180deg,rgba(8,16,24,0.96),rgba(10,22,34,0.92))] p-4 shadow-2xl shadow-black/25">
                  <div className="rounded-[1.35rem] border border-white/10 bg-black/25 p-3">
                    <div className="min-h-[5rem] rounded-[1rem] border border-white/10 bg-white/[0.03] p-4">
